          ...
          child: SingleChildScrollView(
            ...
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: const <Widget>[
                Text(
                  'Abd', // hard core user name at first
                  style: TextStyle(
                    fontSize: 25,
            ...
            const Text(
              ...
              'Category', // hard core user name at first
              style: TextStyle(
                fontSize: 16,
                fontWeight: FontWeight.bold,
              ),
            ...
            Config.spaceSmall,
             const Text(
               'Appointment Today', // hard core user name at first
               style: TextStyle(
                 fontSize: 16,
                 fontWeight: FontWeight.bold,
               ),
                ...
                Config.spaceSmall,
                const Text(
                  'Top Doctors', // hard core user name at first
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                  ),
